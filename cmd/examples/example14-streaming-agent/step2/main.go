// Step 2 — Swap the blocking client.Client for client.SSEClient and stream
// content tokens to stdout as they arrive. Tool calls continue to work via
// the same tool_search_book and tool_get_reading_progress tools. Reasoning
// tokens, the latency ticker, and the usage panel are introduced in later
// steps.
//
// # Running the example
//
//	$ make example14-step2
//
...
// Example 14 — Streaming Agent (Step 2)
package main
