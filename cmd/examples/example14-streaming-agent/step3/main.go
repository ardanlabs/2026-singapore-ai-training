// Step 3 — Render the model's reasoning tokens live (in red) under a
// "> Reasoning:" header before the content tokens stream out under a
// "> Response:" header. Builds on the SSE streaming from step 2. The latency
// ticker and the usage panel are introduced in later steps.
//
// # Running the example
//
//	$ make example14-step3
//
...
// Example 14 — Streaming Agent (Step 3)
package main
