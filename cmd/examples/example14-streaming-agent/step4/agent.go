...
// reasoning tokens (red) and content tokens as they arrive. A latency ticker
// fills the gap before the first token. Returns either the accumulated text
// or any tool calls the model wants executed.
