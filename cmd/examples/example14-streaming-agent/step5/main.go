// Step 5 — Final version. Builds on step 4 by adding a usage/context-window
// panel that prints after each turn (input, reasoning, completion, output,
// context-window utilization, tokens-per-second). This is the complete
// streaming agent: SSE streaming, reasoning rendering, latency ticker, and
// usage panel — all demonstrated against the real tool_search_book (pgvector
// similarity search) and the tool_get_reading_progress stub.
//
// # Running the example
//
//	$ make example14
...
// Example 14 — Streaming Agent (Step 5)
package main
