// This example establishes the baseline for chain-of-call escalation: an
// agent with no defenses is asked to read a sensitive file and write its
// contents elsewhere in a single turn. tool_read_file (safe) and
// tool_write_file (sensitive) are chained read → extract → write, showing
// what an unrestricted agent will do when a prompt requests escalation.
//
// # Running the example
//
//	$ make example27-step1
//
...
// Example 27 — Step 1 — Baseline Escalation Attack (No Defenses)
package main
